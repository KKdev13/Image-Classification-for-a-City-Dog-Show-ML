...
def calculates_results_stats(results_dic):
    ...
    Because the Results Statistics dictionary is created inside of the function
    and is a mutable object, you will need to return its value at the end of the function.
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            ...
            # Number of correct breed matches (pet image and classifier label match)
            if results_dic[key][2] == 1:
